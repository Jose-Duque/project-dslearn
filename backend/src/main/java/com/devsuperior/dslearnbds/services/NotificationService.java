...
public class NotificationService implements DeliverRevisionObserver {
	...
	public Page<NotificationDTO> notificationForUser(boolean unreadOnly, Pageable pageable) {
	...
	public void saveDeliverNotification(Deliver deliver) {
		...
		String route = "/offers/" + offerId +"/resource/" + resourceId + "/sections/" + sectionId;
